...
export default function FloatingToolbar() {
  ...
  return (
    <div className="fixed right-4 bottom-20 z-40 flex flex-col gap-2">
      <button onClick={() => navigate("/chat")} title="Messages" className="w-10 h-10 bg-white hover:bg-gray-50 shadow-lg rounded-xl flex items-center justify-center text-gray-600 hover:text-[#2563EB] transition-colors border border-gray-100">
      ...
      <button onClick={() => navigate("/support")} title="Feedback" className="w-10 h-10 bg-white hover:bg-gray-50 shadow-lg rounded-xl flex items-center justify-center text-gray-600 hover:text-[#2563EB] transition-colors border border-gray-100">
      ...
      <button onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })} title="Back to top" className="w-10 h-10 bg-white hover:bg-gray-50 shadow-lg rounded-xl flex items-center justify-center text-gray-600 hover:text-[#2563EB] transition-colors border border-gray-100">
