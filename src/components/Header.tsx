...
export default function Header() {
  ...
  const handleImagePick = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = async () => {
      ...
      try {
        try { sessionStorage.setItem("mitao:imageSearchPreview", imageBase64); } catch {}
        try { sessionStorage.setItem("mitao:imageSearchPending", imageBase64); } catch {}
        navigate(`/search?image=1`);
      ...
      <div className="bg-[#08152a]/98 backdrop-blur-md border-b border-white/8 shadow-[0_16px_40px_rgba(0,0,0,0.22)]">
        <div className="max-w-screen-xl mx-auto px-3 sm:px-4 py-2.5 lg:py-3">
          <div className="flex flex-wrap items-center gap-2 lg:gap-3">
            ...
            <form onSubmit={handleSearch} className="flex w-full lg:flex-1 lg:max-w-[520px] lg:mx-6 order-3 lg:order-3">
              <div className="flex items-center flex-1 rounded-[22px] border border-white/12 bg-white shadow-[0_16px_34px_rgba(3,7,18,0.16)] overflow-hidden ring-1 ring-black/3">
                ...
                <button
                  ...
                  className="mr-1.5 flex h-11 w-11 items-center justify-center rounded-[16px] bg-white border border-gray-200 text-gray-700 transition-colors hover:bg-gray-50 disabled:opacity-40"
                ...
                >
                  {imageLoading ? (
                    ...
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14M6 20h12a2 2 0 002-2V8a2 2 0 00-2-2h-2l-2-2H10l-2 2H6a2 2 0 00-2 2v10a2 2 0 002 2z" /><circle cx="12" cy="12" r="3" strokeWidth={1.8} /></svg>
                  )}
                </button>
                <button
                  type="submit"
            ...
            <div className="flex items-center justify-end gap-1.5 sm:gap-2 order-2 lg:order-3 ml-auto lg:ml-0">
            <button
              type="button"
              onClick={() => window.dispatchEvent(new Event("mitao:open-install"))}
                ...
                <div className="absolute top-full right-0 mt-2 w-64 bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden z-50">
                  ...
                  <div className="p-2">
                    <button
                      ...
                      className={`w-full flex items-center justify-between px-3 py-2 rounded-lg transition-colors ${currency === "CNY" ? "bg-blue-50 text-[#0A1931]" : "hover:bg-gray-50 text-gray-700"}`}
                    >
                    ...
                    <button
                      ...
                      className={`w-full flex items-center justify-between px-3 py-2 rounded-lg transition-colors ${currency === "USD" ? "bg-blue-50 text-[#0A1931]" : "hover:bg-gray-50 text-gray-700"}`}
                    >
                      <span className="flex items-center gap-2">
                        <span className="text-base">🇺🇸</span>
                    ...
                    <button
                      type="button"
                      onClick={() => { setLanguage("en"); setCurrency("NGN"); setShowLocale(false); }}
                      className={`w-full flex items-center justify-between px-3 py-2 rounded-lg transition-colors ${currency === "NGN" ? "bg-blue-50 text-[#0A1931]" : "hover:bg-gray-50 text-gray-700"}`}
                    >
                      <span className="flex items-center gap-2">
                        <span className="text-base">🇳🇬</span>
                        <span className="text-sm font-semibold">Naira</span>
                      </span>
