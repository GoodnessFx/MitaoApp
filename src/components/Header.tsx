...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-30 shadow-sm">
      {!scrolled && (
        <div className="bg-[#111111] text-xs py-2 px-4">
        ...
        <div className="max-w-screen-xl mx-auto px-4 py-3 flex items-center gap-4">
          <Link to="/" className="flex items-center gap-2 flex-shrink-0">
            <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center">
              <svg className="w-5 h-5 text-[#F97316]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
            </div>
            <span className="font-outfit font-black text-white text-xl tracking-tight">Mitao</span>
          </Link>
          ...
          <div className="flex items-center gap-1">
            <div className="relative" ref={signInRef}>
              <button onClick={() => { setShowSignIn(!showSignIn); setShowSupport(false); }}
                ...
                <span className="text-[10px] hidden lg:block">Sign in</span>
              </button>
            ...
            <div className="relative" ref={supportRef}>
              <button onClick={() => { setShowSupport(!showSupport); setShowSignIn(false); }}
                className="hidden md:flex flex-col items-center text-white/90 hover:text-white px-2 py-1 rounded-lg hover:bg-white/10 transition-colors">
                ...
                <span className="text-[10px] hidden lg:flex items-center gap-0.5">Support <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" /></svg></span>
              </button>
            ...
            <Link to="/cart" className="relative flex flex-col items-center text-white/90 hover:text-white px-2 py-1 rounded-lg hover:bg-white/10 transition-colors">
              ...
              <span className="text-[10px] hidden lg:block">Cart</span>
            </Link>

            <Link to="/orders" className="hidden lg:flex flex-col items-center text-white/90 hover:text-white px-2 py-1 rounded-lg hover:bg-white/10 transition-colors">
